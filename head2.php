...
<body>
  <div id="main">
	...
	<li class="topmenu"><a href="/edit.py" style="height:16px;line-height:16px;"><span>EDIT</span></a>
	<ul>
		<li class="subfirst"><a href="/edit_info.py">Profile</a></li>
		<li class="sublast"><a href="/edit_account.py">Password</a></li>
	</ul>

	</li>
	<li class="topmenu"><a href="/signup.py" style="height:16px;line-height:16px;">SIGN UP</a></li>
	<li class="topmenu"><a href="#" style="height:16px;line-height:16px;">GUEST</a></li>
	<li class="topmenu"><a href="/login.py" style="height:16px;line-height:16px;">LOG IN</a></li>
</ul>
        </ul>
      </div>
    </div>
