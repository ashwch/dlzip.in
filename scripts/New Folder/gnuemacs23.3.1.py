...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		 $size=filesize("../../downloads/ptools/emacs-23.3-bin-i386.zip");
	     ...
	     header("Content-Disposition:attachment;filename=emacs-23.3-bin-i386.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../../downloads/ptools/emacs-23.3-bin-i386.zip");
