...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		// $size=filesize("../../downloads/inetbrowsers/Opera_1101_en_Setup.zip");
	     ...
	     header("Content-Disposition:attachment;filename=Opera_1101_en_Setup.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../../downloads/inetbrowsers/Opera_1101_en_Setup.zip");
