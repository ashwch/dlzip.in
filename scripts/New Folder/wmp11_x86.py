...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		// $size=filesize("../../downloads/mplayers/wmp11-windowsxp-x86-enu.zip");
	     ...
	     header("Content-Disposition:attachment;filename=wmp11-windowsxp-x86-enu.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../../downloads/mplayers/wmp11-windowsxp-x86-enu.zip");
