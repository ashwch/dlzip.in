...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		// $size=filesize("../../downloads/mplayers/audacity-win-1.2.6.zip");
	     ...
	     header("Content-Disposition:attachment;filename=audacity-win-1.2.6.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../../downloads/mplayers/audacity-win-1.2.6.zip");
