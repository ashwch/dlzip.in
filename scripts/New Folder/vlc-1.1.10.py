...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		 $size=filesize("../../downloads/players/vlc/vlc-1.1.10-win32.zip");
	     ...
	     header("Content-Disposition:attachment;filename=vlc-1.1.10-win32.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../../downloads/mplayers/vlc/vlc-1.1.10-win32.zip");
