...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		 $size=filesize("../downloads/office/OOO3.3.0_32-wJRE_en-US.zip");
		     
		     require_once("../includes/scripts/sqlconnection.py");
		     $sid=(int)$_GET['refid'];
	     ...
	     header("Content-Disposition:attachment;filename=OOO3.3.0_32-wJRE_en-US.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../downloads/office/OOO3.3.0_32-wJRE_en-US.zip");
