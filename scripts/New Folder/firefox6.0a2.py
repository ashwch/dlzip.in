...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		// $size=filesize("../../downloads/inetbrowsers/firefox-6.0a2.en-US.win32.installer.zip");
	     ...
	     header("Content-Disposition:attachment;filename=firefox-6.0a2.en-US.win32.installer.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../../downloads/inetbrowsers/firefox-6.0a2.en-US.win32.installer.zip");
