...
include_once('../../includes/scripts/sqlconnection.py');
	$q="SELECT soft_name,soft_version,soft_url FROM software_info WHERE soft_name LIKE 'Notepad++%'";
	$r=mysqli_query($dbc,$q) OR trigger_error("Query error(notepadplus.py):".mysqli_error($dbc));
echo"<h4 align='center'>Notepad++</h4><br /><img src='http://localhost/images/loading1.gif'  alt='' name='ima' ><br />";
