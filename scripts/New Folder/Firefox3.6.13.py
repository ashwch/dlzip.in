...
if(isset($_GET['refid']) && is_numeric($_GET['refid']) && isset($_SESSION['ndr']) && $_SESSION['adr']==md5($_SERVER['HTTP_USER_AGENT']) )
	{
		// $size=filesize("../../downloads/inetbrowsers/Firefox Setup 3.6.13.zip");
	     ...
	     header("Content-Disposition:attachment;filename=Firefox Setup 3.6.13.zip\n");
	     header("Content-Transfer-Encoding:binary\n");
	     //header("Content-Length:$size\n");
         readfile("../../downloads/inetbrowsers/Firefox Setup 3.6.13.zip");
